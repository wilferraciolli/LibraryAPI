...
/**
 * The type User json converter. User is an abstract class therefore it is returned a Pperson class instead.s
 */
@ApplicationScoped
public class UserJsonConverter implements EntityJsonConverter<User> {
    ...
    /**
     * Gets user instance. Return a person because User is an abstract class.
     *
